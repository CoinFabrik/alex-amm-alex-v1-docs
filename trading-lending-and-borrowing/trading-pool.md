...
<mark style="color:green;">**Demo note:**</mark> <mark style="color:green;"></mark><mark style="color:green;">This document will be updated with current v2-01 version, adjusted with an enriched glossary and relevant context information. A link to DEVELOPERS -> Protocol Contracts -> Trading Pool section will be included for developers interested in implementation.</mark>
